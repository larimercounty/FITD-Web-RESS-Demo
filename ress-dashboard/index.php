...
// SET Contants 
//MailChimp API KEY
$MAILCHIMP_API_KEY = '<key goes here>';

//MailChimp allows us to split lists into groups, allowing the user to manage subscriptions in one form
//Assign this to a group that user can subscribe to
$CITIZEN_GROUPS = '<citizen group id goes here>';

//Assign the PARENT_ID the Campaign you are creating - this assigns template and groups reports under that parent
$CAMPAIGN_PARENT_ID = '<campaign id goes here>';

//single list id for priority group if subscribers
$PRIORITY_LIST_ID = '<update priority id>';

$GROUP_ID = '<group id>';

//Index of User Group in Citizens
$LIST_INDEX = '<update with index in list>';
...
//Main RESS List
$citizen_groups = $MailChimp->call('lists/interest-groupings', array('id'=>$CITIZEN_GROUPS,'counts'=>1));
